# YouMeek--增加从 MySQL 读取自定义分词和停用词

- IK 官网：<https://github.com/medcl/elasticsearch-analysis-ik>
- mysql 配置文件：jdbc-reload.properties
- 操作数据库类，加载词典：Dictionary.java
- Maven：clean package 发布 jar
- 创建两张表：
